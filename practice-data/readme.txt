...
Note: The programs in this ZIP file create most of the data sets needed to practice the examples in this guide. 
You will find that some examples are theoretical, illustrative, or "what if" examples. Those data files are not created in the course folder. 
However, if you want to write a program to better understand one of these examples, then you can use the DATA step to create some test data. 
This type of practice will help improve your SAS skills.
